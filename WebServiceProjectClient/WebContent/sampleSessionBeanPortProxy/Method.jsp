...
<LI><A HREF="Input.jsp?method=15&methodName=getBook" TARGET="inputs">getBook()</A></LI>
<LI><A HREF="Input.jsp?method=18&methodName=isBookExist" TARGET="inputs">isBookExist(int)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleSessionBeanPortProxyid.getClass())) {
%>
